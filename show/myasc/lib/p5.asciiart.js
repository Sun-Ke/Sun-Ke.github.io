...
p5.prototype.AsciiArt.prototype.createWeightTable = function() {
  ...
  */
  temp_weightTable.sort((a,b) => a.weight-b.weight)
  for(let i = 0; i < temp_weightTable.length; i++) {
    this.__weightTable[i]={
      code: temp_weightTable[i].code,
      weight: temp_weightTable[i].weight
    }
  }
}
